...
def triangulateFace(image_path, max_paths=5):
    # Load the face image
    ...
    cascade_path = r"C:\Users\varun\SCam\HackHarvard\FaceDatabase\haarcascades\haarcascade_frontalface_default.xml"
...
image_directory = r"C:\Users\varun\SCam\HackHarvard\SessionCapture"
